...
Page({
    ...
    detail:function(e){
      ...
      wx.navigateTo({
        url: '/pages/AccessControlDetail/index?detailData=' + detail
      })
    },
    onSearch:function(){
      wx.request({
        url: 'https://swuse.huantengkj.com/api/HTSL_EntranceGuard/GetPageEntranceGuardListByParam', //仅为示例，并非真实的接口地址
        method:'post',
        data: {
            "rows":this.data.rows,
            'status':1,
            "page":1,
            "RoomName":this.data.value
        },
        header: {
