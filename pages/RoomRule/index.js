...
Page({
    ...
    detail:function(e){
      ...
      wx.navigateTo({
        url: '/pages/RoomRuleDetail/index?detailData=' + detail
      })
    },
    onSearch:function(){
      wx.request({
        url: 'https://swuse.huantengkj.com/api/HTSL_SafeRule/GetPageSafeRuleListByParam', //仅为示例，并非真实的接口地址
        method:'post',
        data: {
            "rows":this.data.rows,
            'status':1,
    ...
    Search:function(){
      wx.request({
        ...
        data: {
            ...
            'status':1,
            "page":1,
            "SafeRuleTypeName":this.data.value,
    ...
    onLoad: function (options) {
        ...
        wx.request({
          ...
          //   university.push(item.text)
          //   this.setData({
          //     universityData:university,
          //   })
          //   item.children.forEach((item)=>{
          //       college.push(item.text)
          //       this.setData({
          //         collegeData:college,
          //       })
          //   })
